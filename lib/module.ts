import { Port, usePorts } from "./di.v2";
 ...
 */
export function createModule<T extends Record<string, Port<any>>>(
	ports: T,
): Module<T> {
 ...
 */
export function useModule<T extends Record<string, Port<any>>>(
	module: Module<T>,
): {
