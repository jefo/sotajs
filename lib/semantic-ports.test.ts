...
export type UserUpdatedOutput = z.infer<typeof UserUpdatedOutputSchema>;
export type UserUpdateFailedOutput = z.infer<
	typeof UserUpdateFailedOutputSchema
>;
...
export const UserUpdatedOutPort =
	createPort<(dto: UserUpdatedOutput) => Promise<void>>();
export const UserUpdateFailedOutPort =
	createPort<(dto: UserUpdateFailedOutput) => Promise<void>>();
...
export const findUserByIdPort =
	createPort<(id: string) => Promise<User | null>>();
...
describe("Semantic Output Ports Pattern", () => {
	...
	it("should pass business outcome DTOs to output ports, not UI components", async () => {
		...
		const capturingUserUpdateFailed = mock(
			async (dto: UserUpdateFailedOutput) => {
